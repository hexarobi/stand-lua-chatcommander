...
return {
    ...
    "The dealer will always go bust. after they draw their first 2 cards.",
    "OPTIONAL FOR MORE WINNINGS: If your first 2 cards total less than 12, always double down. The dealer will bust, and you'll win.",
    "Remember, Ace can be either 11 or 1, your choice. If you need more help, google it :)",
